...
//		TiledMapTileSet tileSet = actor.getTiledMap().getTileSets().getTileSet("tuile");
//		TiledMapTileLayer tiledLayer = (TiledMapTileLayer) this.actor.getTiledMap().getLayers().get("OBJET_0");
//
